  ...
  data: function () {
    return {
      ...
      chunks: [
        {
          icon: ['fab', 'github'],
          title: this.$t('Jsk1.Source code'),
          content: `<a href="https://github.com/FreeTubeApp/FreeTube">GitHub: FreeTubeApp/FreeTube</a><br>${this.$t('Jsk1.Licensed under the AGPLv3')} <a href="https://www.gnu.org/licenses/agpl-3.0.en.html">${this.$t('About.View License')}</a>`
        },
        {
          icon: 'file-download',
          title: this.$t('Jsk1.Downloads / Changelog'),
          content: `<a href="https://github.com/FreeTubeApp/FreeTube/releases">${this.$t('jsk1.GitHub releases')}</a>`
        },
        {
          icon: 'question-circle',
          title: this.$t('Jsk1.Help'),
          content: `<a href="https://docs.freetubeapp.io/">${this.$t('Jsk1.FreeTube Wiki')}</a> / <a href="https://docs.freetubeapp.io/faq/">${this.$t('Jsk1.FAQ')}</a>`
        },
        {
          icon: 'exclamation-circle',
          title: this.$t('Jsk1.Report a problem'),
          content: `<a href="https://github.com/FreeTubeApp/FreeTube/issues">${this.$t('Jsk1.GitHub issues')}</a><br>${this.$t('About.Please check for duplicates before posting')}`
        },
        {
          icon: 'globe',
          title: this.$t('Jsk1.Website'),
          content: '<a href="https://freetubeapp.io/">https://freetubeapp.io/</a>'
        },
        {
          icon: 'newspaper',
          title: this.$t('Jsk1.Blog'),
          content: '<a href="https://blog.freetubeapp.io">https://blog.freetubeapp.io</a>'
        },
        {
          icon: 'envelope',
          title: this.$t('Jsk1.Email'),
          content: '<a href="mailto:FreeTubeApp@protonmail.com">FreeTubeApp@protonmail.com</a>'
        },
        {
          icon: ['fab', 'mastodon'],
          title: this.$t('Jsk1.Mastodon'),
          content: '<a href="https://mastodon.technology/@FreeTube">@FreeTube@mastodon.technology</a>'
        },
        {
          icon: 'comment-dots',
          title: this.$t('Jsk1.Chat on Matrix'),
